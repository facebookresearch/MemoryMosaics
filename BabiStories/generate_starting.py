...
parser.add_argument('--prompt', type=str, default="Please give me 100 ways to open children's story. Avoid repeated first words! Remember to only use simple words!")
parser.add_argument('--out_dir', type=str, default='data/')
args = parser.parse_args()

if not os.path.exists(os.path.join(args.out_dir, f'startings{args.idx}.txt')):
    ...
    f = open(os.path.join(args.out_dir, f'startings{args.idx}.txt'), 'w')
